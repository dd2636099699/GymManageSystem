...
<head>
    ...
    <script>
                    ...
                    { field:'xxx',title:'会员状态',
                        formatter:function (value,row,index) {
                            if(row.memberStatic==1){
                                ...
                                return "<p style='color:red'>已到期</p>"
                            }
                        }
                    },
        ...
        function search(){
            ...
            $.post("${pageContext.request.contextPath}/menber/query2",{"pageSize":opt.pageSize,"pageNumber":opt.pageNumber,"hyname":hyid,"ktype":ktype},function (releset) {
        ...
        function tianjia() {
            ...
            var data=$('#data').val();
            var age=$('#age').val();
            $.post("${pageContext.request.contextPath}/menber/insert",{"memberName":name,"memberPhone":phone,"memberSex":sex,"birthday":srdata,"Membertypes.typeId":optype,"nenberDate":data,"memberAge":age},function (releset) {
                if(releset != null){
                    $("#dg").bootstrapTable('load',releset) ;
