...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a>健身房管理系统 管理页</a></div>
        <div class="left_open">
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/menber/jin0">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>监控仪表板</cite>
                        </a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        ...
                        <a _href="${pageContext.request.contextPath}/cz/xuka">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>续卡记录</cite>
...
<%--                    </li>--%>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/classRoom/jin1">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>教室列表</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/courseSchedule/jin1">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>课程安排</cite>
                        </a>
                    </li >
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/CourseSale/jin">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>课程售卖情况</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath}/qc/reservejin">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>器材预约</cite>
                        </a>
                    </li >
