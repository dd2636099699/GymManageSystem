package com.luguzhi.gymxmjpa.enums;
...
public enum ErrorCodeEnum {
    ...
    public static com.luguzhi.gymxmjpa.enums.ErrorCodeEnum getDescriptionByCode(Integer code){
        for(com.luguzhi.gymxmjpa.enums.ErrorCodeEnum errorCodeEnum : com.luguzhi.gymxmjpa.enums.ErrorCodeEnum.values()){
            if(code.equals(errorCodeEnum.getCode())){
                return errorCodeEnum;
            }
        }
        return  com.luguzhi.gymxmjpa.enums.ErrorCodeEnum.UNKNOWN;
    }
