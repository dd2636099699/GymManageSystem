...
import com.luguzhi.gymxmjpa.factory.FaceEngineFactory;
...
public class FaceEngineServiceImpl implements FaceEngineService {
    ...
    public final static Logger logger = LoggerFactory.getLogger(com.luguzhi.gymxmjpa.service.FaceEngineServiceImpl.class);
    ...
    @Autowired
    private UserFaceInfoService userFaceInfoServic;
    ...
    public List<FaceUserInfo> compareFaceFeature(byte[] faceFeature, Integer groupId) throws InterruptedException, ExecutionException {
        ...
        List<FaceUserInfo> faceInfoList = userFaceInfoServic.getUserFaceInfoByGroupId(groupId); //从数据库中取出人脸库
