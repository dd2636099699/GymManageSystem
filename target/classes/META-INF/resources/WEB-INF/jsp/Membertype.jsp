                ...
                columns:[
                    ...
                    { field:'typemoney',title:'售价',sortable: true},
                    {
                        ...
                        formatter: function(value, row, index) {
                            return "<a href='javascript:upd1(" + row.typeId + ")' class='fa fa-edit'></a>" +
                                " <a href='javascript:del1(" + row.typeId + ")' class='fa fa-trash'></a>";
                        }
                    }
                ],
                queryParamsType:'',
   ...
   function save(){
       if(!validateAdd()){
           return;
            ...
            var money = $("#money").val();
            $("#myModal").modal("hide") ;
            $.post('${pageContext.request.contextPath}/metype/add',{'typeName':name,'typeDay':tianshu,'typemoney':money},function(data){
       ...
       function upd1(id){
        ...
        function upd(){
            ...
            $("#myModal2").modal("hide") ;
            $.post('${pageContext.request.contextPath}/metype/upd',{'typeId':id,'typeName':name,'typeDay':tianshu,'typemoney':money},function(data){
                $.post("${pageContext.request.contextPath}/ktype/queryq",{"pageSize":opt.pageSize,"pageNumber":opt.pageNumber,"typeName":typeId},function (releset) {
                    $("#table").bootstrapTable('load',releset) ;
                })
                $("#table").bootstrapTable("load",data) ;
