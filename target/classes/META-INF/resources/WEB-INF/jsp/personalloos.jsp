    ...
    <div class="panel-body">
        <form class="form-inline">
            ...
            <button onclick="search()" type="button" class="btn btn-default" style="margin-top: 20px" >查询</button>
             <button type="button" class="btn btn-default" onclick="loos()" style="float: right; margin-top: 20px; display: none" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span>添加拾取物详情</button>
      </form>
    </div>
