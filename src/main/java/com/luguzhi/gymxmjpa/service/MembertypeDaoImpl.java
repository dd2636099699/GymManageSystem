...
import com.luguzhi.gymxmjpa.dao.MemberttypeDao;
...
public class MembertypeDaoImpl {
    ...
    public Map<String,Object> query(Map<String,Object> map1){
        ...
        if(map1.get("typeName")!=null && !map1.get("typeName").equals("")){
            jpal= String.format("%s and TypeName like '%%%s%%'", jpal, map1.get("typeName"));
        }
        ...
        if(map1.get("typeName")!=null && !map1.get("typeName").equals("")){
            jpa= String.format("%s and TypeName like '%%%s%%'", jpa, map1.get("typeName"));
        }
