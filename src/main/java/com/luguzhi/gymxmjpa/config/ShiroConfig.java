package com.luguzhi.gymxmjpa.config;

import com.luguzhi.gymxmjpa.realm.MyRealm;
...
public class ShiroConfig {
    ...
    public HashedCredentialsMatcher getHashedCredentialsMatcher() {
        ...
        // 设置加密次数为1，因为数据库中存储的是经过一次MD5加密的哈希值
        credentialsMatcher.setHashIterations(1);
        // 设置这个是很重要的，它影响到存储的密码字符串的比较方式（十六进制）
    ...
    public MyRealm myRealm() {
        ...
        return myRealm; // 返回配置了CredentialsMatcher的实例
    }
...
//    }
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(){
        ...
        map.put("/demo.jsp","anon");
        map.put("/face_registration.jsp","anon");
        map.put("/face_search.jsp","anon");
